# BEGIN  Initialization file for the ***loadlibrary*** package directory
#
...
#
# END  Initialization file for the ***loadlibrary*** package directory

from project_constants              import OS

# Library paths (dictionary). for rust interface modules in he loadlibrary package  src_business
libpaths = {
                OS.LINUX: "../target/x86_64-unknown-linux-gnu/",     # Rust Lib
                OS.WIN: "../target/x86_64-pc-windows-gnu/",
